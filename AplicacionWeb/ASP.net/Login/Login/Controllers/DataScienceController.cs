...
{
    [ApiController]
    [Route("api/preguntas/DataScience")]
    ...
    public class DataScienceController : ControllerBase
    {
        ...
        public object Get(int idUnity)
        {
            ...
            DataScienceRoot jsonObject = JsonConvert.DeserializeObject<DataScienceRoot>(allText);

            return jsonObject.Data_Science[idUnity];
        }
    }
